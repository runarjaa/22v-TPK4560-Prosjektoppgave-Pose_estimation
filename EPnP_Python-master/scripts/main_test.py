...
class EPnPTest(object):
    ...
    def draw_input_noisy_data(self):
        ...
        fig.savefig("D:\\Skole\\Semester 10\\Prosjektoppgave\\EPnP_Python-master\\output" + '\\Noise_in_Image_Plane.png', dpi=100)
        # plt.show()
    ...
    def plot_3d_reconstruction(self, method, Xc):
        ...
        fig.savefig("D:\\Skole\\Semester 10\\Prosjektoppgave\\EPnP_Python-master\\output\\" + method + '_Reprojection_Error.png', dpi=100)
        # plt.show()
